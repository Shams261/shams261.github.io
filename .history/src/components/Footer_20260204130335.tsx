      ...
      <footer id="connect" className="relative overflow-hidden">
        ...
        <div className="bg-black text-white py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="bg-gray-900/50 rounded-3xl p-8 lg:p-12 border border-gray-800">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                ...
                >
                  <h3 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight tracking-tighter mb-6">
                    LET'S TALK
                  </h3>
                  <p className="text-lg text-gray-400 mb-8 max-w-lg leading-relaxed">
                    Ready to bring your ideas to life? Fill out the form and
                ...
                <motion.div
                  ...
                  className="lg:pl-8"
                >
                  <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight tracking-tighter mb-6">
                    LET'S MAKE IT
                    <br />
