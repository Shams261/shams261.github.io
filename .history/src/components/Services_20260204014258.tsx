  ...
  return (
    <Section id="services" title="What I Do" className="bg-zinc-950">
      ...
      >
        ...
        >
          I specialize in building intelligent, scalable applications that push
          the boundaries of what's possible. With a solid foundation in AI/ML
          and system design, I help bring innovative ideas to life.
        </motion.p>
      </motion.div>
