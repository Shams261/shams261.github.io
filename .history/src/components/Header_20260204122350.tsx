      ...
      >
        <div className="flex justify-between items-center h-14 px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-gray-600 tracking-tight hidden sm:block">
              Software Engineer
            </span>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <nav className="flex items-center gap-1 mr-4">
              {navLinks.map((link) => (
                <Link
                  key={link.name}
                  href={link.href}
                  className="relative px-4 py-2 text-[14px] font-semibold text-gray-600 hover:text-black transition-colors duration-300 group rounded-full hover:bg-black/5 tracking-tight"
                >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2 bg-black text-white text-[14px] font-semibold rounded-full hover:bg-gray-800 transition-all duration-300 tracking-tight"
            >
              Let's Talk
              <svg
                className="w-3 h-3"
            ...
            <div className="flex flex-col p-4">
              {navLinks.map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="block py-3 px-4 text-[16px] font-semibold text-gray-800 hover:text-black hover:bg-black/5 rounded-xl transition-all duration-300 tracking-tight"
              ...
              <motion.a
                ...
                href="mailto:shamsshoaib261@gmail.com"
                className="mt-2 mx-4 py-3 bg-black text-white text-center font-semibold rounded-full tracking-tight"
                onClick={() => setIsOpen(false)}
              >
                Let's Talk
              </motion.a>
