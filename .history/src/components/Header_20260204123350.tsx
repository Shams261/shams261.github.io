              ...
              <div className="flex flex-col gap-6">
                {navLinks.map((link, index) => (
                  ...
                  >
                    <Link
                      href={link.href}
                      className="block py-3 text-xl font-semibold text-black hover:text-gray-600 transition-colors duration-300"
                ...
                <motion.a
                  ...
                  href="mailto:shamsshoaib261@gmail.com"
                  className="inline-flex items-center justify-center mt-6 px-8 py-4 bg-black text-white text-lg font-semibold rounded-full hover:bg-gray-800 transition-all duration-300"
                  onClick={() => setIsOpen(false)}
                >
                  Let's Talk
                </motion.a>
