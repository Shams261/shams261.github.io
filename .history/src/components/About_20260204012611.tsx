...
import { FaMapMarkerAlt, FaClock, FaTrophy, FaGraduationCap, FaBriefcase } from "react-icons/fa";
...
const About = () => {
  const highlights = [
    ...
    },
    {
      ...
      description: "Enterprise SaaS • 30% performance improvements • Team leadership",
    },
    {
  ...
  return (
    <Section id="about" title="About Me" className="bg-zinc-900">
      <motion.div
        ...
        <motion.div variants={itemVariants} className="space-y-6">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-zinc-300 text-lg leading-relaxed mb-6">
              Building scalable apps, websites, and automations. I understand what advantages modern tech can provide, 
              helping me advise on the solutions a business actually needs.
            </p>
            <p className="text-zinc-400 leading-relaxed">
              I'm a passionate Software Engineer with a knack for building full-stack web applications using modern 
              technologies like Next.js and TailwindCSS. My journey in tech began with a curiosity for solving 
          ...
          <div className="bg-gradient-to-r from-zinc-800/50 to-zinc-700/50 backdrop-blur-sm rounded-2xl p-6 border border-zinc-700/50">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <h4 className="text-white font-semibold mb-1">Thunder Bay, Canada</h4>
                <p className="text-emerald-400 text-sm mb-2">48.3809° N, 89.2477° W • GMT-5</p>
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-emerald-400 text-sm font-medium">{highlight.subtitle}</p>
                      <p className="text-zinc-400 text-sm mt-1">{highlight.description}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
      ...
      >
        <p className="text-zinc-300 text-lg mb-4">
          <span className="font-semibold text-white">Available for new opportunities:</span> Let's build something amazing together.
        </p>
        <motion.a
          href="#connect"
