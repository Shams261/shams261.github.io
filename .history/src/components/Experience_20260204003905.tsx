...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      description: [
        Resolved 150+ production defects by implementing systematic debugging workflows to fix root causes, reducing critical
issue backlog by 50% and improving application uptime from 97% to 99.2%
• Engineered frontend UI enhancements using JavaScript, implementing responsive design patterns and form validation
logic across 20+ application screens, which decreased user-reported errors by 25% and improved user satisfaction scores
• Established testing protocols and created 25+ technical documentation artifacts using Git and Postman, reducing new
developer onboarding time from 3 weeks to 2 weeks (35% improvement)
      ],
    },
  ];
