      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-neutral-400 text-lg max-w-3xl mx-auto">
            <span className="text-neutral-500">(TECHNOLOGIES)</span> A comprehensive toolkit of modern technologies 
            and frameworks for building scalable, high-performance applications.
          </p>
        </motion.div>
