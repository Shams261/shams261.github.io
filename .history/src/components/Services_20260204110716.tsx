  ...
  const services = [
    {
      ...
      description:
        "From intelligent recommendation systems to natural language processing, I build AI-powered applications that solve real-world problems.",
      technologies: [
    ...
    },
    {
      ...
      description:
        "End-to-end web applications with modern frameworks. Clean code, scalable architecture, and seamless user experiences.",
      technologies: [
    ...
    },
    {
      ...
      description:
        "Systems that scale efficiently with caching strategies, optimization techniques, and cloud infrastructure.",
      technologies: [
        ["AWS", "Docker", "CI/CD"],
