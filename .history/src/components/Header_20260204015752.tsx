  ...
  return (
    <motion.header
      ...
      className={`fixed w-full z-50 transition-all duration-500 ${
        scrolled
          ? "bg-black/90 backdrop-blur-xl border-b border-neutral-800/50 shadow-2xl shadow-black/20"
          : "bg-transparent"
      }`}
    >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden bg-black/95 backdrop-blur-xl border-b border-neutral-800/50"
          >
