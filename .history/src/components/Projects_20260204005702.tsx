    ...
    <Section id="projects" title="Featured Projects" className="bg-gray-50 dark:bg-gray-900">
      ...
      >
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          A curated selection of projects that demonstrate my technical expertise and problem-solving abilities.
        </p>
      </motion.div>
      ...
      <div className="space-y-32">
        {displayedProjects.map((project, index) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-indigo-600 dark:text-indigo-400 tracking-wider uppercase">
                  {project.title === 'InterviewBuddy' || project.title === 'Verity' ? 'AI APPLICATION' : 
                   project.title === 'DevConnect' ? 'FULL-STACK PLATFORM' : 'ML PROJECT'}
                </span>
            ...
            {/* Project Content */}
            <div className={`grid ${index % 2 === 0 ? 'lg:grid-cols-[1fr,1.2fr]' : 'lg:grid-cols-[1.2fr,1fr]'} gap-12 items-center`}>
              {/* Text Content */}
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 rounded-3xl p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Discover my complete collection of projects, experiments, and contributions on GitHub
            </p>
            <motion.a
