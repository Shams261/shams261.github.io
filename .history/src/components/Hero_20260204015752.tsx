          ...
          >
            ...
            >
              <div className="text-center">
                <div className="text-2xl font-bold text-white mb-1">MS in CS</div>
                <div className="text-sm text-neutral-500">Lakehead University • 3.89 GPA</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white mb-1">2+ Years</div>
                <div className="text-sm text-neutral-500">Software Engineer at Accenture</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white mb-1">🏆 Winner</div>
                <div className="text-sm text-neutral-500">AI Hackathon • Verity Project</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
