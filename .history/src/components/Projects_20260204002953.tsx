...
const Projects = () => {
  const projects = [
    ...
    },
    {
      title: "Verity",
      description:
        "Verity is an AI-powered platform that helps users understand Canadian public discourse by analyzing millions of Reddit posts. Using advanced RAG (Retrieval-Augmented Generation) technology with Groq's ultra-fast LLM inference.",
      image: "/verity.png",
      technologies: [
        "React",
        "TypeScript",
