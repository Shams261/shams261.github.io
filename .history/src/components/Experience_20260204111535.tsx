      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-16 xl:px-24">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-500 max-w-3xl leading-relaxed">
            3+ years of hands-on experience building enterprise-scale
                ...
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                  ...
                  <div className="lg:col-span-4">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <span className="text-sm lg:text-base text-gray-600 bg-white px-4 lg:px-5 py-2 lg:py-2.5 rounded-full border border-gray-200 group-hover:bg-gray-50 group-hover:border-gray-300 transition-all duration-300">
                        {exp.period}
                      </span>
                      <span className="text-sm lg:text-base text-gray-600 bg-white px-4 lg:px-5 py-2 lg:py-2.5 rounded-full border border-gray-200 group-hover:bg-gray-50 group-hover:border-gray-300 transition-all duration-300">
                        {exp.location}
        ...
        >
          <span className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-green-50 text-green-700 text-base lg:text-lg font-medium border border-green-200">
            <span className="w-2.5 h-2.5 bg-green-500 rounded-full animate-pulse" />
            Currently seeking Full-Stack & AI/ML Engineering Roles
          </span>
        </motion.div>
      </div>
    </section>
