      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-neutral-400 text-lg max-w-4xl mx-auto leading-relaxed">
            <span className="text-neutral-500">(SERVICES)</span> I specialize in building AI-powered applications and scalable 
            architectures that are fast, reliable, and user-friendly. With a solid foundation in both 
            machine learning and system design, I help bring innovative ideas to life.
          </p>
        </motion.div>
