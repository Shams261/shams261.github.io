    ...
    >
      <div className="space-y-12">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-center bg-gradient-to-r from-zinc-800/50 to-zinc-700/50 backdrop-blur-sm rounded-2xl p-8 border border-zinc-700/50"
        >
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-4">
            <span className="font-semibold">Professional Experience:</span> 2+
            years at Accenture with expertise in enterprise SaaS platforms,
            microservices architecture, and AI/ML integration.
          </p>
          <p className="text-gray-600 dark:text-gray-400">
            <span className="font-semibold">Methodologies:</span> Agile/Scrum,
            CI/CD, Test-Driven Development, RESTful API Design
          </p>
        </motion.div>
      </div>
    </Section>
