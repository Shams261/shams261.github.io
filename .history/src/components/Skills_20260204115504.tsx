  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Express.js", icon: <FaNodeJs size={24} /> },
        { name: "FastAPI", icon: <FaPython size={24} /> },
        { name: "REST APIs", icon: <TbApi size={24} /> },
        { name: "WebSockets", icon: <TbApi size={24} /> },
        { name: "OAuth", icon: <FaGithub size={24} /> },
        { name: "JWT", icon: <TbApi size={24} /> },
      ],
    },
    {
      number: "03",
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "LangChain", icon: <FaBrain size={24} /> },
        { name: "Embeddings", icon: <FaBrain size={24} /> },
        { name: "Vector Search", icon: <FaDatabase size={24} /> },
        { name: "Git", icon: <FaGitAlt size={24} /> },
        { name: "GitHub", icon: <FaGithub size={24} /> },
        { name: "Postman", icon: <TbApi size={24} /> },
      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-16 xl:px-24">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-500 max-w-3xl leading-relaxed">
            A curated toolkit I use to ship production-ready applications—clean
            UX, reliable APIs, and scalable systems.
          </p>
        </motion.div>
