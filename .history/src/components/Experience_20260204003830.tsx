...
"Designed and optimized backend APIs and SQL queries powering analytics workflows, improving data retrievalperformance by 40% and enabling real-time reporting for client-facing features"
      ],
    },
    {
