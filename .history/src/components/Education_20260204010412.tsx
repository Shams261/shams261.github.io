...
const Education = () => {
  ...
  return (
    <Section id="education" title="Education" className="bg-white dark:bg-gray-800">
      <motion.div
      ...
      >
        ...
        <motion.div
          variants={itemVariants}
          className="text-center bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl p-8"
        >
