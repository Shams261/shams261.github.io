        ...
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          >
            ...
            >
              <div className="relative">
                <span className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
                  SHAMS TABREZ
                </span>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium text-sm rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/25"
            >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={toggleMenu}
            className="lg:hidden relative w-10 h-10 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center transition-colors duration-300 hover:bg-gray-200 dark:hover:bg-gray-700"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-b border-gray-200/20 dark:border-gray-700/20"
          >
              ...
              <div className="flex flex-col space-y-4">
                {navLinks.map((link, index) => (
                  ...
                  >
                    <Link
                      href={link.href}
                      className="group flex items-center py-3 text-lg font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all duration-300"
                ...
                >
                  <a
                    href="mailto:shamsshoaib261@gmail.com"
                    className="flex items-center justify-center w-full py-3 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-xl transition-all duration-300 hover:shadow-lg"
                    onClick={() => setIsOpen(false)}
                  >
                    Let's Connect
                  </a>
