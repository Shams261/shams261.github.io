  ...
  const services = [
    {
      ...
      description:
        "I integrate LLMs into real productschat experiences, document Q&A, semantic search, and smart matching—designed with cost control, latency, and safety in mind.",
      technologies: [
