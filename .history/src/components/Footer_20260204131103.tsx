  ...
  return (
    <>
      <footer id="connect" className="relative overflow-hidden">
        ...
        <div className="bg-black text-white py-12 lg:py-16 mx-6 lg:mx-12 xl:mx-16 rounded-[2rem] lg:rounded-[2.5rem] border border-gray-900 shadow-2xl shadow-gray-200/30 overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="bg-gray-900/60 rounded-[1.75rem] lg:rounded-[2rem] p-6 lg:p-10 border border-gray-800 ring-1 ring-white/5">
              <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-start">
                ...
                >
                  ...
                  <p className="text-lg text-gray-400 mb-8 max-w-lg leading-relaxed">
                    I’m actively looking for Full‑Stack / Software Engineer roles. If you’re hiring—or want to collaborate—send a quick note and I’ll respond fast.
                  </p>
                ...
                >
                  ...
                  <p className="text-lg text-gray-400 mb-10 max-w-xl leading-relaxed">
                    Open to full‑time opportunities (Toronto/Remote) and high‑impact builds—AI features, scalable backends, and polished UI. Let’s connect.
                  </p>
        ...
        {/* Bottom Bar */}
        <div className="bg-gray-950 py-6 mx-6 lg:mx-12 xl:mx-16 mb-8 rounded-[2rem] lg:rounded-[2.5rem] border border-gray-900 overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              >
                Shams Tabrez<span className="text-gray-500"></span>
              </a>
