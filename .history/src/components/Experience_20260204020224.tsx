      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-neutral-400 text-lg max-w-3xl mx-auto">
            <span className="text-neutral-500">(PROFESSIONAL JOURNEY)</span> 2+
            years of hands-on experience building enterprise-scale applications
            and leading development teams at Accenture.
          </p>
        </motion.div>
